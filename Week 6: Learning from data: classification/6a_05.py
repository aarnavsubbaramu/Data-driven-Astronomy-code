...
#Use the RandomForestClassifier class from the sklearn.ensemble module. It is instantiated with:
...
#The function is to return two NumPy arrays containing the predicted and actual classes respectively.
#Copy and paste the functions from previous questions. However, we have provided the generate_features_targets function in the support library.
...
def rf_predict_actual(data, n_estimators):
  ...
  rtree = RandomForestClassifier(n_estimators)

  #get predictions using 10-fold cross validation with cross_val_predict
  predicted = cross_val_predict(rtree, features, targets, cv = 10)
